...
var msg2 = "Om iktel.nl te kunnen gebruiken moet je je een nieuwere versie van je web browser downloaden.";
...
if (navigator.userAgent && 
    ...
    msg2 = "Om iktel.nl te kunnen gebruiken moet je de compatibiliteitsmodus uitzetten door <a href='https://sites.google.com/a/khanacademy.org/forge/technical/how-to-disable-internet-explorer-compatibility-view'> deze instructies te volgen</a>.";
...
document.body.clientHeight ) ) {
    ...
    // msg2 needs to support non-plaintext HTML content.
    var _linkDiv = document.createElement('div');
    _linkDiv.innerHTML = msg2;
    _p1.appendChild(_linkDiv);
