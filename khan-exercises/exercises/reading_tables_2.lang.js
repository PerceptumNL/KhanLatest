({
    "nl":{
        "array1":'<var id="ROWS">[ [ school(1), school(2), school(3), school(4) ], [ person(1), person(2), person(3), person(4) ], [ person(1), person(2), person(3), person(4) ], [ "Drenthe", "Groningen", "Friesland", "Utrecht" ] ][ INDEX ]</var>',
        "array2":'<var id="COLUMNS">[ [ "Groep 6", "Groep 7", "Groep 8", "Totaal" ], [ "Januari", "Februari", "Maart", "Totaal" ], [ "1e kwart", "2e kwart", "3e kwart", "4e kwart", "Totaal" ], [ "Q1", "Q2", "Q3", "Q4", "Totaal" ] ][ INDEX ]</var>',
        "array3":'<var id="PROBLEM">[ "toont het aantal leerlingen in groep 6 t/m 8 op vier basisscholen", "toont het aantal kippen dat van januari t/m maart is verkocht door vier vrienden", "geeft het aantal punten aan dat door vier spelers is gescoord in een basketbalwedstrijd", "toont het aantal in het afgelopen jaar ge&iuml;nstalleerde zonnepanelen per provincie" ][ INDEX ]</var>',
        "array4":'<var id="HEADER">[ "Scholen", "Boeren", "Spelers", "Provincies" ][ INDEX ]</var>',
        "array5":'<var id="UNIT">[ "leerlingen", "kippen", "punten", "zonnepanelen" ][ INDEX ]</var>',
        "array6":'<var id="HINT1">' +
            '			(function() {' +
            ...
            '	})()' +
            '</var>',
        "array7":'<var id="HINT2">[ "Het totale aantal leerlingen op de " + ROWS[ ROW_INDEX ], "Het totale aantal kippen verkocht door " + ROWS[ ROW_INDEX ], "Het totale aantal punten gescoord door " + ROWS[ ROW_INDEX ], "Het totale aantal ge&iuml;nstalleerde zonnepanelen in " + ROWS [ ROW_INDEX ] ][ INDEX ]</var>',
        "hint1":'Onderstaande tabel <var>PROBLEM</var>, maar 1 waarde ontbreekt.',
