({
	"nl" : {
		...
		"hint1"		: 'Wie heeft de meeste <var>BADGE</var> afbeeldingen naast <var>his( MOST + 1 )</var> naam staan?',
		"hint2"		: '<var>person( MOST + 1 )</var> heeft de meeste afbeeldingen naast <var>his( MOST + 1)</var> naam staan.',
		"hint3"		: '<var>person( MOST + 1 )</var> heeft de meeste <var>BADGE</var> badges verdiend.',
		"hint4"		: 'Wie heeft de minste <var>BADGE</var> afbeeldingen naast <var>his( LEAST + 1 )</var> naam staan?',
		"hint5"		: '<var>person( LEAST + 1 )</var> heeft de minste afbeeldingen naast <var>his( LEAST + 1)</var> naam staan.',
		"hint6"		: '<var>person( LEAST + 1 )</var> heeft de minste <var>BADGE</var> badges verdiend.',
		"hint7"		: 'Onderaan de infographic staat dat elke afbeelding <var>plural( VALUE_PER_IMG, "badge" )</var> vertegenwoordigt.',
		"hint8"		: 'Kijk naar de rij van <var>person( PERSON + 1 )</var> in de tabel: '+
					...
					'</div>',
		"hint9"		: 'Er <var>plural( "is", "zijn", DATA[PERSON] )</var> <var>plural( DATA[ PERSON ], "afbeelding", "afbeeldingen" )</var>.',
		"hint10"	: '<code><var>DATA[ PERSON ]</var></code> <var>plural( "afbeelding", "afbeeldingen", DATA[ PERSON ] )</var>'+
					  '	<code> \\times </code> <code><var>VALUE_PER_IMG</var></code> <var>plural( "badge", VALUE_PER_IMG )</var> per afbeelding '+
