({
	"nl" : {
		...
		"question4"	: 'Hoeveel "Gallons" gas was er over in de tank?',
		...
		"problem1"	: '<var>person( 1 )</var> heeft 5 vrienden uitgenodigd voor <var>his( 1 )</var> verjaardagsfeestje. Sommige mensen hadden andere plannen en waren verhinderd, maar <code>\frac{<var>N</var>}{<var>D</var>}</code> van de mensen die <var>person( 1 )</var> had uitgenodigd konden wel komen.',
		...
		"problem4"	: 'Voordat hij op vakantie gaat, vult <var>person( 1 )</var> <var>his( 1 )</var> gastank, welke <var>GALLONS</var> "Gallons" gas kan bevatten. Na <var>0.5 * randRange( 3 / 0.5, 10 / 0.5 )</var> uur merkt <var>person( 1 )</var> op dat de gastank voor <code>\frac{<var>N</var>}{<var>D</var>}</code> gevuld is.',
		...
		"problem6"	: '<var>person(1)</var> heeft koekjes gebakken voor een benefiet. . <var>He(1)</var> found a recipe that called for <code>\frac{<var>N</var>}{<var>D</var>}</code> of a cup of chocolate chips.',
		...
		"hint16"	: '<strong><var>person( 1 )</var> had <var>SOLUTION</var> "Gallons" gas over in <var>his( 1 )</var> gastank toen hij <var>he( 1 )</var> dit controleerde.</strong>',
