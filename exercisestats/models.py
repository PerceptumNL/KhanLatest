...
class ExerciseStatistic(db.Model):
    ...
    def get_by_dates_and_exids(exids, dates):
        # TODO(david): Optimizations: we could either parallelize the
        ...
        return filter(lambda x: x is not None, ex_stats)

    def num_proficient(self):
        histogram = self.histogram['proficiency_problem_number_frequencies']
