...
class ApiRequest(Request, RequestInputHandler):
    ...
    # Patch up a flask request object to behave a little more like
    # webapp.RequestHandler for the sake of our 3rd party
    # oauth_provider library
    ...
    # Make request_string behave like
    # request_handler.RequestHandler.request_string so the rest of
    # RequestInputHandler inherits properly.
