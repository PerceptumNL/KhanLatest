({
	"nl" : {
		...
		"hint6" : 'Vermenigvuldig de twee onechte breuken: <code><var>fraction( I_NUM_1, I_DENOM_1, false, true )</var></code> * <code><var>fraction(  I_NUM_2, I_DENOM_2, false, true )</var></code><code>\displaystyle {} = <var>fraction( I_NUM, I_DENOM )</var></code>',
		"hint7" : 'Maak van de onechte breuk een gemengde breuk:',
		"hint8" : 'Deel de teller door de noemer. <code><var>I_NUM</var> \div <var>I_DENOM</var> = \color{#28AE7B}{<var>WHOLE_3</var>}\ \text{ R } \color{purple}{<var>NUM_3</var>}</code>',
		"hint9" : 'De onechte breuk heeft dus <code class="hint_green"><var>WHOLE_3</var></code> gehele getallen.'
		"hint10" : 'De quotient  <code class="hint_green"><var>WHOLE_3</var></code> is het gehele getal van de gemengde breuk.',
		"hint11" : 'We hebben als restwaarde nog  <code class="hint_purple"><var>NUM_3</var></code> over. Deze staat voor de <code>\dfrac{\color{purple}{<var>NUM_3</var>}}{<var>DENOM_3</var>}</code> van de overgebleven onechte breuk, want deze was niet voldoende om nog een heel getal te kunnen destilleren.'.
