({
	"nl" : {
		...
		"hint1"		: 'Elk re&euml;el getal vermenigvuldigd met <code>1</code> is gelijk aan zichzelf.',
		"hint2"		: 'Zonder ook maar 1 vermenigvuldiging uit te voeren weten we dat <code><var>NUM</var> \\times 1 = <var>NUM</var></code>.',
		"hint3"		: 'Dat een getal niet van waarde verandert als je het vermenigvuldigt met <code>1</code> is een wetmatigheid en handig bij het vinden van gelijkwaardige breuken.',
		...
		"hint6"		: 'Dat de waarde van een getal niet verandert als je er <code>0</code> bij optelt is een wetmatigheid die opgaat voor alle re&euml;ele getallen.',
		...
		"hint10"		: 'De regel dat <code>x \\times \\dfrac{1}{x} = 1</code> geldt voor alle re&euml;ele getallen.',
		"hint11"		: 'Het optellen van het tegengestelde van een getal, bij dat getal, geeft een uitkomst gelijk aan <code>0</code>.',
		...
		"hint14"		: "Het optellen van de negatieve waarde van een getal bij dat getal om <code>0</code> te krijgen is een wetmatigheid die geldt voor alle re&euml;le getallen."
		}
})