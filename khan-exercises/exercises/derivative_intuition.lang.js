({
	"nl" : {
		"question1"	: 'Drag each one of the <var>POINTS.length</var> <span class="hint_orange">orange</span> points up and down'+
						'to adjust the slope of the corresponding tangent line.',
		"question2"	: '	The derivative of a function is defined as the slope of a line tangent to the curve at each point.'+
						'Adjust the slopes of the lines to visually find the	derivative <code>\frac{d}{dx} f(x)</code> at each point.',
		
		"hint1"		: 'The orange curve shows the derivative of <code>f(x)</code>. Drag all of the orange points'+
