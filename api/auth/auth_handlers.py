...
from api.auth.auth_util import (oauth_error_response, requested_oauth_callback,
                                access_token_response, custom_scheme_redirect,
...
# Our API's OAuth authentication and authorization is designed to
# encapsulate the OAuth support of our identity providers
# (Google/Facebook), so each of our mobile apps and client
# applications don't have to handle each auth provider
# independently. We behave as one single OAuth set of endpoints for
# them to interact with.


# Request token endpoint
#
# Flask-friendly version of
# oauth_providers.oauth_request.RequestTokenHandler that hands off to
# Google/Facebook to gather the appropriate request tokens.
...
#
# Flask-friendly version of
# oauth_providers.oauth_request.AuthorizeHandler that doesn't require
# user authorization for our side of the OAuth. Just log in, and we'll
# authorize.
...
#
# Flask-friendly version of
# oauth_providers.oauth_request.AccessTokenHandler that creates our
# access token and then hands off to Google/Facebook to let them
