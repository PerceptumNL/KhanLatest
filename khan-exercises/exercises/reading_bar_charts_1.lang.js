({
	"nl" : {
		...
		"hint3"	:	'<var>HOUSES[ INDEX ]</var> heeft vandaag <var>plural( VALUES[ INDEX ], "punt","punten")</var> ontvangen.',
		"answertype":	'<span style="padding-right: 5px" class="sol"><var>VALUES[ INDEX ]</var></span> punten'
	}
})