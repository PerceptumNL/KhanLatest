({
	"nl" : {
		"exercise" : 'Welk getal staat <strong><var>plural( abs( DISTANCE ), "positie")</var> <span data-if="DISTANCE < 1">links</span><span data-else>rechts</span> van de oranje stip</strong>? De afstand tussen de streepjes is 1.',
		...
		"hint2"	:	"Getallen aan de linkerkant van de <code><var>MIDPOINT</var></code> zijn kleiner, en getallen aan de rechterkant zijn groter dan <code><var>MIDPOINT</var></code>",
