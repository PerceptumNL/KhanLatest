...
class UnfinishedExerciseBadge(ExerciseBadge):
    ...
    def is_satisfied_by(self, *args, **kwargs):
        ...
        # Make sure they've done the required minimum of problems in
        # this exercise
        ...
        # Make sure the last problem is from this exercise and that
        # they got it right
        ...
        # Look through the last 50 problems. If they've done at least
        # 10 in the exercise and gotten at least 75% correct, give 'em
        # the badge.
        ...
        # Make sure they've done at least 10 problems in this exercise
        # out of their last 50
        if c_total < 10:
            return False
