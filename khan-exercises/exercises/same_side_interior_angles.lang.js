({
	"nl" : {
		...
		"hint2"		: 'It makes sense that the pink angles are equal because they are opposite each other.',
		"hint3"		: 'One of the pink angles corresponds with the orange angle, and the other pink angle forms an alternate interior angle.',
		"hint4"		: 'The orange angle equals the pink angles and measures <var>180 - MEASURE</var> degrees.',
		"hint5"		: 'Note that the blue and orange angles are supplementary.'
		}
})