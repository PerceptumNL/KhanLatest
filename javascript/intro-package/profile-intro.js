    ...
    Profile.showIntro_ = function () {
        if (Profile.profile.isPhantom()) {
            ...
            guiders.createGuider({
                ...
                description:"Jouw profielpagina laat je precies zijn welke " +
                    "voortgang je hebt geboekt op iktel.nl. Als je " +
        ...
        if (isFullyEditable && !showDiscussionIntro) {
            guiders.createGuider({
                ...
                title:"Deel met de wereld <span style='font-size:65%'>(alleen als je dat wilt)" +
                    "</span>",
                description:"Maak je profiel openbaar en deel de informatie die hier wordt getoond. Je kunt het altijd weer op privé zetten."
            });
        }
    };
}
