({
	"nl" : {
		"question1"	: '<var>person(1)</var> heeft <var>plural( NUM, fruit( 0 ) )</var> voor elke <var>plural( DENOM, fruit( 1 ) )</var>. Noteer de verhouding van <var>fruit( 0 )</var> tot <var>fruit( 1 )</var> als een vereenvoudigde breuk.',

		"hint1"		: 'Verhoudingen (of ratio\'s) kunnen op verschillende manieren geschreven worden.',
