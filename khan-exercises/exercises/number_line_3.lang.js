({
	"nl" : {
		"exercise" : 'Welk getal staat <strong><var>plural( abs( DISTANCE ), "positie")</var> <span data-if="DISTANCE < 1">links</span><span data-else>rechts</span> van de oranje stip</strong>? De afstand tussen twee streepjes is 1.',
